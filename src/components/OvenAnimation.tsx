    ...
    <div className="relative w-16 h-16 mx-auto">
      ...
      <div className="absolute inset-0 border-4 border-forest-dark dark:border-white/80 rounded-xl overflow-hidden bg-white/10">
        ...
        <div className="absolute top-4 left-2 right-2 bottom-2 border-2 border-forest-dark/50 dark:border-white/50 rounded-lg bg-orange-500/20 overflow-hidden">
          {/* Glowing Heat */}
          <div className="absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-orange-500/60 to-transparent animate-pulse" />
          {/* Baking Tray */}
          <div className="absolute bottom-2 left-2 right-2 h-1 bg-forest-dark/80 dark:bg-white/80 rounded-full" />
          {/* Steam/Heat waves */}
          <div className="absolute bottom-4 left-1/4 w-1 h-4 bg-orange-400/50 rounded-full animate-[ping_2s_ease-in-out_infinite]" style={{ animationDelay: '0ms' }} />
          <div className="absolute bottom-4 left-1/2 w-1 h-6 bg-orange-400/50 rounded-full animate-[ping_2s_ease-in-out_infinite]" style={{ animationDelay: '500ms' }} />
          <div className="absolute bottom-4 right-1/4 w-1 h-3 bg-orange-400/50 rounded-full animate-[ping_2s_ease-in-out_infinite]" style={{ animationDelay: '1000ms' }} />
        </div>
        {/* Oven Knobs */}
